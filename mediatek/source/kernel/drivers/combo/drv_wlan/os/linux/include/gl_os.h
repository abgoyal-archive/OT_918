...
/*
** $Id: //Department/DaVinci/BRANCHES/MT6620_WIFI_DRIVER_V1_2/os/linux/include/gl_os.h#4 $
*/
 ...
 *
 * 02 21 2011 cp.wu
 * [ALPS00031620] [Need Patch] [Volunteer Patch][MT6620 Wi-Fi][Driver] Simplify logic for checking NVRAM existence in driver domain
 * sync. with main trunk for simplifying NVRAM checking logic.
 *
 * 02 12 2011 terry.wu
 * [WCXRP00000442] [MT6620 Wi-Fi][Driver] Create Wi-Fi P2P V1.2 Branch
 * Sync symbol for P2P module.
 *
