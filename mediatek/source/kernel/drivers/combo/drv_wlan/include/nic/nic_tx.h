...
/*
** $Id: //Department/DaVinci/BRANCHES/MT6620_WIFI_DRIVER_V1_2/include/nic/nic_tx.h#1 $
*/
 ...
 *
 * 04 12 2011 cp.wu
 * [ALPS00039763] [Need Patch] [Volunteer Patch][MT6620 Wi-Fi][Driver] Add an API to query for current TX available counter and invoke callback for MGMT being dropped in driver domain
 * 1. add API nicTxGetResource() for QM to make decision with arwareness of available TX counter
 * 2. when MGMT frames are dropped in driver domain, callback will be invoked as well
 *
 * 03 21 2011 cp.wu
