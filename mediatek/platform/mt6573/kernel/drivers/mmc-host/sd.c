...
/*
 * if definition of MT6573_SD_DEBUG has defined, the debug log will be compiled
 * in the kernel. if this is not you wanted, please comment the definition.
 */
...
/*
 * Following definition is for Re-Try
 */
#define SD_FALSE             -1
#define SD_TRUE               0
...
/*
 * NOTICE: If the polling argument is not ture, it will be in
 * spin_lock(host->lock) enviroment after this function has been called.
 */
static unsigned int mt6573_sd_send_command(struct mt6573_sd_host *host,
		struct mmc_command    *cmd,
		int                    polling,
