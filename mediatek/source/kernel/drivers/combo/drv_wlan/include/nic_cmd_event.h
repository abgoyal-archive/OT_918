...
/*
** $Id: //Department/DaVinci/BRANCHES/MT6620_WIFI_DRIVER_V1_2/include/nic_cmd_event.h#2 $
*/
 ...
 *
 * 08 15 2011 cp.wu
 * [ALPS00066667] [Need Patch] [Volunteer Patch][MT6620 Wi-Fi] Wi-Fi hot spot with auto sparse channel residence
 * 1. expose rlmDomainIsLegalChannel() and scnQuerySparseChannel for p2p.ko
 * 2. retrieve sparse channel information from firmware
 *
 * 06 23 2011 cp.wu
 ...
 *
 * 06 23 2011 cp.wu
 * [ALPS00055301] [Need Patch] [Volunteer Patch][MT6620 Wi-Fi][Driver] Workaround for frequency over-shifted WAPI APs support
 ...
 * [ALPS00037861] [Need Patch] [Volunteer Patch] [MT6620 Wi-Fi] [FW] [Driver] BssInfo can get the security mode which is WPA/WPA2/WAPI or not.
 * .
 *
 * WiFi FW Label : MT6620_WIFI_FW_V2_0_E1E3_20110331_1830
 *
 * 03 21 2011 cp.wu
 ...
 *
 * 03 08 2011 cp.wu
 * [ALPS00033615] [Need Patch] [Volunteer Patch][MT6620 Wi-Fi][Driver] Update command/event definition to sync. with latest firmware image
 * sync. for firmware event definition change.
 *
 * 02 10 2011 cp.wu
...
typedef enum _ENUM_CMD_ID_T {
    ...
    CMD_ID_SCAN_REQ_LEGACY,             /* 0x04 (Set) */
...
typedef struct _CMD_SET_BSS_INFO {
    ...
    UINT_8  aucBSSID[6];
    UINT_8  ucIsQBSS;
    UINT_8  fgIsShortPreambleAllowed;
    UINT_16 u2OperationalRateSet;
    UINT_16 u2BSSBasicRateSet;
    UINT_8  ucStaRecIdxOfAP;
    UINT_8  fgUseShortPreamble;
    UINT_8  fgUseShortSlotTime;
