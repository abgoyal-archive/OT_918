 ...
 * - MT6573 4+4: 0x1E00000
 * - MT6573 4+2: 0x1700000
 */
...
/*
 * The following framebuffer related source code is to determine 
 * if the FB is initialized or not by bootloader.
 * FB driver use this information to determine the necessarity of 
 * frambuffer initialization
 */
struct {
	u32 base;
	u32 size;
...
/*
 * Note!! You have to copy the above data structure and functions for porting fixup function
 */
 ...
 * get_pmem_range
 * Input
 *   pu4StartAddr: buffer base physical address
 *   pu4Size: buffer len in byte
 */
