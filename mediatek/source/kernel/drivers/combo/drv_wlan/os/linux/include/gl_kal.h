...
/*
** $Id: //Department/DaVinci/BRANCHES/MT6620_WIFI_DRIVER_V1_2/os/linux/include/gl_kal.h#1 $
*/
 ...
 *
 * 04 12 2011 cp.wu
 * [ALPS00039964] [Need Patch] [Volunteer Patch][MT6620 Wi-Fi][Driver] Clear pending security frames when QM clear pending data frames for dedicated network type
 * include link.h.
 *
 * 04 12 2011 cp.wu
 * [ALPS00039964] [Need Patch] [Volunteer Patch][MT6620 Wi-Fi][Driver] Clear pending security frames when QM clear pending data frames for dedicated network type
