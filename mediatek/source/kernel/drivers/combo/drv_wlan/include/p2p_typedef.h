...
/*
** $Id: //Department/DaVinci/BRANCHES/MT6620_WIFI_DRIVER_V1_2/include/p2p_typedef.h#3 $
*/
...
typedef VOID (*NIC_P2P_MEDIA_STATE_CHANGE) (
...
typedef WLAN_STATUS (*P2P_PARSE_CHECK_FOR_P2P_INFO_ELEM)(
    IN  P_ADAPTER_T prAdapter,
    IN  PUINT_8 pucBuf,
    OUT PUINT_8 pucOuiType
    );

typedef BOOLEAN (*SCAN_UPDATE_P2P_DEVICE_DESC) (
    IN P_ADAPTER_T prAdapter,
    IN P_BSS_DESC_T prBssDesc
    );

typedef VOID (*P2P_FSM_RUN_EVENT_RX_PROBE_RESPONSE_FRAME)(
    IN P_ADAPTER_T prAdapter,
    IN P_SW_RFB_T prSwRfb,
    IN P_BSS_DESC_T prBssDesc
    );
...
typedef WLAN_STATUS (*P2P_RX_PUBLIC_ACTION_FRAME) (
    IN P_ADAPTER_T prAdapter,
    IN P_SW_RFB_T prSwRfb
    );
...
typedef VOID (*P2P_GENERATE_WSC_IE_FOR_BEACON)(
    IN P_ADAPTER_T        prAdapter,
    IN P_MSDU_INFO_T      prMsduInfo
    );

typedef UINT_32 (*P2P_CALCULATE_WSC_IE_LEN_FOR_BEACON) (
    IN P_ADAPTER_T prAdapter,
    IN ENUM_NETWORK_TYPE_INDEX_T eNetTypeIndex,
    IN P_STA_RECORD_T prStaRec
    );
...
typedef UINT_32 (*P2P_CALCULATE_WSC_IE_LEN_FOR_PROBE_RSP) (
    IN P_ADAPTER_T prAdapter,
    IN ENUM_NETWORK_TYPE_INDEX_T eNetTypeIndex,
    IN P_STA_RECORD_T prStaRec
    );

typedef VOID (*P2P_GENERATE_WSC_IE_FOR_PROBE_RSP)(
    IN P_ADAPTER_T        prAdapter,
    IN P_MSDU_INFO_T      prMsduInfo
    );
...
typedef VOID (*SCAN_REMOVE_P2P_BSS_DESC) (
    IN P_ADAPTER_T prAdapter,
    IN P_BSS_DESC_T prBssDesc
    );
...
typedef VOID (*P2P_HANDLE_SEC_CHECK_RSP) (
    IN P_ADAPTER_T prAdapter,
    IN PUINT_8       pucRsp,
    IN UINT_16       u2RspLen
    );
