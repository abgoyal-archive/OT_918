...
/*
** $Id: //Department/DaVinci/BRANCHES/MT6620_WIFI_DRIVER_V1_2/include/nic/mac.h#1 $
*/
 ...
 *
 * 06 22 2011 wh.su
 * [ALPS00054996] [Need Patch] [Volunteer Patch] Move the WPA/RSN IE and WAPI IE structure to mac.h and let the sw structure not align at byte
 * Adjust the IE length check rule.
 *
 * 06 22 2011 wh.su
 * [ALPS00054996] [Need Patch] [Volunteer Patch] Move the WPA/RSN IE and WAPI IE structure to mac.h and let the sw structure not align at byte
 * Move the WAPI/RSN IE to mac.h and SW structure not align to byte, 
 * Notice needed update P2P.ko
 * ALPS_WIFI_P2P_DRIVER_V2_0_20110622_1330..
 *
 * 05 06 2011 wh.su
 * [ALPS00044737] [MT6620][connection]can't connect with AP after overnight.
