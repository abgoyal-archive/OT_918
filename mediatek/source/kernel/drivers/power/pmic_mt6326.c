...
/**********************************************************
  *
  *   [I2C Test Case] read / write slave device (sysfs_create_bin_file )
  *
  *********************************************************/
#if 0  
...
/***********************************************************
  *  Check BUCK / LDO is ON or OFF API
  **********************************************************/
