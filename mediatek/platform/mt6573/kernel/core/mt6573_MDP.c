...
void MT6573MDP_DUMPREG(void)
{
    ...
    MDPDB("BRZ REG:\n ********************\n");
    for(u4Index = 0 ; u4Index < 0x34 ; u4Index += 4){
        u4RegValue = ioread32(BRZ_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    }    
    ...
    MDPDB("PRZ0 REG:\n ********************\n");
    for(u4Index = 0 ; u4Index < 0x24 ; u4Index += 4){
        u4RegValue = ioread32(PRZ0_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    }
    u4RegValue = ioread32(PRZ0_BASE+0x40);
    MDPDB("+0x%x 0x%x\n", 0x40 , u4RegValue);
    u4RegValue = ioread32(PRZ0_BASE+0x80);
    MDPDB("+0x%x 0x%x\n", 0x80 , u4RegValue);
    u4RegValue = ioread32(PRZ0_BASE+0x84);
    MDPDB("+0x%x 0x%x\n", 0x84 , u4RegValue);
    for(u4Index = 0xB0 ; u4Index < 0xD4 ; u4Index += 4){
        u4RegValue = ioread32(PRZ0_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    }
    for(u4Index = 0xF0 ; u4Index < 0xFC ; u4Index += 4){
        u4RegValue = ioread32(PRZ0_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    }
    ...
    MDPDB("PRZ1 REG:\n ********************\n");
    for(u4Index = 0 ; u4Index < 0x24 ; u4Index += 4){
        u4RegValue = ioread32(PRZ1_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    }
    u4RegValue = ioread32(PRZ1_BASE+0x40);
    MDPDB("+0x%x 0x%x\n", 0x40 , u4RegValue);
    u4RegValue = ioread32(PRZ1_BASE+0x80);
    MDPDB("+0x%x 0x%x\n", 0x80 , u4RegValue);
    u4RegValue = ioread32(PRZ1_BASE+0x84);
    MDPDB("+0x%x 0x%x\n", 0x84 , u4RegValue);
    for(u4Index = 0xB0 ; u4Index < 0xD4 ; u4Index += 4){
        u4RegValue = ioread32(PRZ1_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    ...
    MDPDB("IPP REG:\n ********************\n");
    for(u4Index = 0 ; u4Index < 0x8 ; u4Index += 4){
        u4RegValue = ioread32(IMGPROC_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    }
    for(u4Index = 0x100 ; u4Index < 0x138 ; u4Index += 4){
        u4RegValue = ioread32(IMGPROC_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    }
    for(u4Index = 0x200 ; u4Index < 0x26C ; u4Index += 4){
        u4RegValue = ioread32(IMGPROC_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    }
    for(u4Index = 0x320 ; u4Index < 0x32C ; u4Index += 4){
        u4RegValue = ioread32(IMGPROC_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    }
    ...
    MDPDB("ROTDMA1 REG:\n ********************\n");
    for(u4Index = 0 ; u4Index < 0x8C ; u4Index += 4){
        u4RegValue = ioread32(ROT_DMA1_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    }
    for(u4Index = 0x300 ; u4Index < 0x37C ; u4Index += 4){
        u4RegValue = ioread32(ROT_DMA1_BASE+u4Index);
    ...
    u4RegValue = ioread32(ROT_DMA1_BASE+0x400);
    MDPDB("+0x%x 0x%x\n", 0x400 , u4RegValue);
    u4RegValue = ioread32(ROT_DMA1_BASE+0x418);
    MDPDB("+0x%x 0x%x\n", 0x418 , u4RegValue);
    u4RegValue = ioread32(ROT_DMA1_BASE+0x430);
    MDPDB("+0x%x 0x%x\n", 0x430 , u4RegValue);
    for(u4Index = 0x800 ; u4Index < 0x838 ; u4Index += 4){
        u4RegValue = ioread32(ROT_DMA1_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    ...
    MDPDB("ROTDMA2 REG:\n ********************\n");
    for(u4Index = 0 ; u4Index < 0x8C ; u4Index += 4){
        u4RegValue = ioread32(ROT_DMA2_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    }
    for(u4Index = 0x300 ; u4Index < 0x37C ; u4Index += 4){
        u4RegValue = ioread32(ROT_DMA2_BASE+u4Index);
    ...
    u4RegValue = ioread32(ROT_DMA2_BASE+0x400);
    MDPDB("+0x%x 0x%x\n", 0x400 , u4RegValue);
    u4RegValue = ioread32(ROT_DMA2_BASE+0x418);
    MDPDB("+0x%x 0x%x\n", 0x418 , u4RegValue);
    u4RegValue = ioread32(ROT_DMA2_BASE+0x430);
    MDPDB("+0x%x 0x%x\n", 0x430 , u4RegValue);
    for(u4Index = 0x800 ; u4Index < 0x838 ; u4Index += 4){
        u4RegValue = ioread32(ROT_DMA2_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    ...
    MDPDB("ROTDMA3 REG:\n ********************\n");
    for(u4Index = 0 ; u4Index < 0x8C ; u4Index += 4){
        u4RegValue = ioread32(ROT_DMA3_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    }
    for(u4Index = 0x300 ; u4Index < 0x37C ; u4Index += 4){
        u4RegValue = ioread32(ROT_DMA3_BASE+u4Index);
    ...
    u4RegValue = ioread32(ROT_DMA3_BASE+0x400);
    MDPDB("+0x%x 0x%x\n", 0x400 , u4RegValue);
    u4RegValue = ioread32(ROT_DMA3_BASE+0x418);
    MDPDB("+0x%x 0x%x\n", 0x418 , u4RegValue);
    u4RegValue = ioread32(ROT_DMA3_BASE+0x430);
    MDPDB("+0x%x 0x%x\n", 0x430 , u4RegValue);
    for(u4Index = 0x800 ; u4Index < 0x838 ; u4Index += 4){
        u4RegValue = ioread32(ROT_DMA3_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    ...
    MDPDB("RDMA0 REG:\n ********************\n");
    for(u4Index = 0 ; u4Index < 0x84 ; u4Index += 4){
        u4RegValue = ioread32(R_DMA0_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    }
    for(u4Index = 0x340 ; u4Index < 0x3E8 ; u4Index += 4){
        u4RegValue = ioread32(R_DMA0_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    }
    ...
    MDPDB("RDMA1 REG:\n ********************\n");
    for(u4Index = 0 ; u4Index < 0x84 ; u4Index += 4){
        u4RegValue = ioread32(R_DMA1_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    }
    for(u4Index = 0x340 ; u4Index < 0x3E8 ; u4Index += 4){
        u4RegValue = ioread32(R_DMA1_BASE+u4Index);
    ...
    MDPDB("JPGDMA REG:\n ********************\n");
    for(u4Index = 0 ; u4Index < 0x24 ; u4Index += 4){
        u4RegValue = ioread32(JPG_DMA_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    }
    for(u4Index = 0x90 ; u4Index < 0xB0 ; u4Index += 4){
        u4RegValue = ioread32(JPG_DMA_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    }
    ...
    MDPDB("VRZ REG:\n ********************\n");
    for(u4Index = 0 ; u4Index < 0x28 ; u4Index += 4){
        u4RegValue = ioread32(VRZ_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    }
    u4RegValue = ioread32(VRZ_BASE+0x40);
    MDPDB("+0x%x 0x%x\n", 0x40,u4RegValue);
    u4RegValue = ioread32(VRZ_BASE+0x5C);
    MDPDB("+0x%x 0x%x\n", 0x5C,u4RegValue);

    MDPDB("OVL REG:\n ********************\n");
    for(u4Index = 0 ; u4Index < 0x14C ; u4Index += 4){
        u4RegValue = ioread32(OVL_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    }
/*
    MDPDB("GMC~EMI REG:\n ********************\n");
    for(u4Index = 0x2510 ; u4Index < 0x2534 ; u4Index += 4){
        u4RegValue = ioread32(MMSYS1_CONFIG_BASE+u4Index);
        MDPDB("+0x%x 0x%x\n", u4Index,u4RegValue);
    }
    for(u4Index = 0x2510 ; u4Index < 0x2534 ; u4Index += 4){
...
static int MT6573_CLR_IRQ(unsigned long a_u4IRQFlag)
{
    ...
    switch(a_u4IRQFlag)
    {
        case ROTDMA0_FLAG :
            ...
            spin_lock_irqsave(&g_stMT6573ZoomReg.ResLock , flags);
...
static int MT6573_SetZoom(stZoomSetting * a_u4Param)
{
    ...
    g_stMT6573ZoomReg.u4Dirty = 0;
    spin_unlock_irqrestore(&g_stMT6573IRQTbl.ResLock , u4Flags);
