...
/*
** $Id: //Department/DaVinci/BRANCHES/MT6620_WIFI_DRIVER_V1_2/include/config.h#3 $
*/
 ...
 *
 * 04 14 2011 cp.wu
 * [ALPS00040455] [Need Patch] [Volunteer Patch][MT6620 Wi-Fi][Driver] Integration for MT6620 whole chip resetting mechanism
 * integrate reset event retrieve mechanism to 6620 Wi-Fi driver
 *
 * 04 11 2011 george.huang
 * [ALPS00039363] [Wifi][6620][E4][IOT throughput] After connect to Atheros AP(Testbed). Run 11N throughput . Always fail to aggregation .Then throughput is too low.
 * Disable U-APSD function for STA (all AC to be legacy AC)
 *
 * label: MT6620_E3_FW_DRIVER_2011_0411_2134..
 *
 * 03 21 2011 cp.wu
 ...
 * [ALPS00033389] [MT6620 Wi-Fi][FW][Driver] Add BT 3.0 HS feature
 * [ALPS00033389] [Need Patch] [Volunteer Patch][MT6620 Wi-Fi][Driver][FW] Enable BOW feature,
 * WiFi Driver Label : MT6620_WIFI_DRIVER_V1_2_BOW_20110306_22_49,
 * WiFi FW Label : MT6620_WIFI_FW_V1_2_BOW_20110306_12_06.
 *
 * 02 25 2011 george.huang
 * [ALPS00032235] [Need Patch] [Volunteer Patch] [MT6620 Wi-Fi][FW] Change default UAPSD AC assignment
 * Modify U-APSD AC assignment.
 *
 * 02 14 2011 wh.su
 * [ALPS00030770] [MT6620 Wi-Fi][Driver] Enable the privacy check at hotspot mode
 * let the privacy check for hotspot default enable.
 *
 * 02 14 2011 cp.wu
 * [ALPS00030504] [Need Patch] [Volunteer Patch][MT6620 Wi-Fi][Firmware] Add Wi-Fi firmware image used by MT6620 E3 ASIC
 * re-enable NVRAM checking.
 *
 * 02 11 2011 cp.wu
 * [WCXRP00000430] [MT6620 Wi-Fi][Firmware][Driver] Create V1.2 branch for MT6620E1 and MT6620E3
 * disable BT_OVER_WIFI for current V1.2 release.
 *
 * 02 09 2011 wh.su
...
#define MTK_SUPPORT_DEEP_IDLE                   1
#endif
...
#define CFG_RX_MAX_PKT_SIZE                     2048 // TODO: it should be 4096 under emulation mode
...
#if defined(_HIF_SDIO) && CFG_SDIO_RX_AGG
