...
/*
char const* const mau1PortName[MAU1_MASK_ALL] = {
...
char const* const mpuHPortName[MPU_H_MASK_ALL] = {
    [MPU_H_MASK_JPGDMA_R          ] = "jpgdma_r",
    [MPU_H_MASK_JPGDMA_W          ] = "jpgdma_w",
    [MPU_H_MASK_ROTDMA0_OUT1      ] = "rot_dma0_out1",
    [MPU_H_MASK_ROTDMA0_OUT2      ] = "rot_dma0_out2",
    [MPU_H_MASK_ROTDMA1_OUT1      ] = "rot_dma1_out1",
    [MPU_H_MASK_ROTDMA1_OUT2      ] = "rot_dma1_out2",
    [MPU_H_MASK_ROTDMA2_OUT1_OUT2 ] = "rot_dma2_out1_2",
    [MPU_H_MASK_ROTDMA3_OUT1_OUT2 ] = "rot_dma3_out1_2",
    [MPU_H_MASK_TVROT_OUT1_OUT2   ] = "tv_rot_out1_2",
    [MPU_H_MASK_GREQ_BLKW         ] = "greq_blkw",
    [MPU_H_MASK_GREQ_BLKR         ] = "greq_blkr",
    [MPU_H_MASK_RDMA_G2D          ] = "rdma_g2d",
    [MPU_H_MASK_JPG_DEC_RDMA_EIS  ] = "jpg_dec_rdma_eis",
    [MPU_H_MASK_TVC_PFH           ] = "tvc_pfh",
    [MPU_H_MASK_TVC_RESZ          ] = "tvc_resz",
    [MPU_H_MASK_ROT_DMA_PT        ] = "rot_dma_pt",
    [MPU_H_MASK_TVROT_RDES_EIS    ] = "tvrot_rdes_eis",
    [MPU_H_MASK_ROT_DMA_DES       ] = "rot_dma_des",
};
*/
...
/*
static _MAU_CONTEXT mau1_ctxt = {0};
static _MAU_CONTEXT mau2_ctxt = {0};
*/
