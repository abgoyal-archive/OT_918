...
/*
** $Id: //Department/DaVinci/BRANCHES/MT6620_WIFI_DRIVER_V1_2/include/wlan_lib.h#1 $
*/
 ...
 * [ALPS00064676] [Volunteer Patch][WiFi Direct][Driver] Fix the GO TX unicast deauth issue to one connected device.
 * Support TX deauth frame under GO mode.
 * Davinci Label: 20110802_ALPS_WIFI_P2P_DRIVER_V2_0.
 *
 * 05 31 2011 cp.wu
 ...
 *
 * 05 11 2011 cp.wu
 * [ALPS00047388] [MT6620 Wi-Fi] modify the behavior of set tx power
 * change ACPI setting API to wlan_lib.c for glue layer's invoking.
 *
 * 03 04 2011 cp.wu
 * [ALPS00030504] [Need Patch] [Volunteer Patch][MT6620 Wi-Fi][Firmware] Add Wi-Fi firmware image used by MT6620 E3 ASIC
 * migrate from MT6620 E1/E2 to MT6620 E3 on
 * 1. NVRAM content definition and loading
 * 2. NVRAM default TX-PWR parameters
 * 3. Change MT6573-EVB from MT6620 E2 to MT6620 E3
 *
 * 02 09 2011 cp.wu
